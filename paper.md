...
Low-intensity transcranial direct current stimulation (tDCS) is a non-invasive brain stimulation method, which applies constant current between two or more electrodes placed over the scalp [@antal2017low]. TDCS is typically applied at intensities between 1 and 2 mA, which induces mild to moderate amount of adverse-effects that include cutaneous discomfort, such as itching or tingling sensations [@poreisz2007safety; @matsumoto2017adverse; @fertonani2015you].
...
1 mA-20 min tDCS is a frequently used stimulation protocol, which is assumed to be effectively blinded by FSF active sham protocol. However, this assumption is based on 24 healthy volunteers and 23 chronic stroke patients with a mean age between 46.3 and 62.3 years [@gandiga2006transcranial]. Recent evidence indicates that younger participants experience more intense cutaneous discomfort than older counterparts [@wallace2016perceived] and therefore, younger adults might better distinguish between real and active sham stimulation, which could compromise effective blinding in younger adults. Our analysis suggest that blinding is compromised for tDCS at 1 mA for 20 min. One possible explanation for this difference between the present and Gandiga's study is that our sample size was larger and the sample itself consisted of younger volunteers. We found our results still suprising, since the present study used a 30s fade-in/out period, whereas Gandiga and colleagues' protocol used 10s fade-in and no fade-out period [@gandiga2006transcranial]. Note that longer fade-in/out periods are supposed to further improve the blinding efficacy of the FSF protocol. Taking together, these findings imply that developing new active sham protocol, which can effectively blind tDCS at 1 mA for 20 min is strongly recommended. 
