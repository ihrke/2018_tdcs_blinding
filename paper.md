...
## Experimenter
The experimenter (author J.G.), who was responsible for the recruitment and data collection in Amsterdam had a first aid certification (obtained 2-11-2017) and a background in clinical neuropsychology and cognitive neuroscience and experience with performing EEG, MEG, and (f)MRI experiments (certified 7T MR operator). The experimenter has taken knowledge of the safety and ethical considerations of transcranial electrical stimulation. The experimenter was supported during the pilot sessions by a researcher with experience in tDCS (by Anne Trutti) and met the requirement of performing tDCS on her own. 
...
Three experimenters collected the data in Tromsø, (including author N.B.). Two were native Norwegian speakers (male, female), whereas one of them was fluent Norwegian at C1 level (according to the Common European Framework of Reference for Languages ). N.B. completed the 13th Practical Course in Non-invasive Brain Stimulation in Goettingen. All experimenters were carefully trained by the authors G.C. and M.M. before the start of the pilot measurements. 
