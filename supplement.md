...
![Impedance at the start of the experiment across labs and stimulation conditions. The protocol required the impedance to be below 10k$\Omega$, therefore there are no higher values than that. Black points and bars are means and confidence intervals.](pics/impedance.png){ #fig:impedance width=100% }
